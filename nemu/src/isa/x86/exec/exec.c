...
make_group(gp1,
    ...
    /*?*/EMPTY, /*0x83 /5 sub*/EX(sub), EMPTY, EMPTY)
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x54 */	EMPTY, /*0x55 push r16/32*/IDEX(r, push), EMPTY, EMPTY,
  /* 0x58 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x5c */	EMPTY, /*0x5d pop r16/32*/IDEX(r, pop), EMPTY, EMPTY,
  /* 0x60 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,
  /* 0x68 */	/*0x68 push imm32*/IDEXW(I, push, 4), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, /*0xc3 ret32*/EXW(ret, 4),
  ...
  /* 0xe8 */	/*0xe8 call r32*/IDEXW(I, call, 4), EMPTY, EMPTY, EMPTY,
