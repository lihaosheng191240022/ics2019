...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x68 */	/*0x68 push ib*/IDEXW(I, push, 1), /*69 imul3*/IDEX(I_E2G, imul3), /*6a push imm8*/IDEXW(I, push, 1), EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), /*c1 shift r/l*/IDEX(I2E, gp2), EMPTY, /*0xc3 ret16/32*/EX(ret),
  ...
  /* 0xe8 */	/*0xe8 call r16/32*/IDEX(push_SI, call), /*e9 jmp*/IDEX(J, jcc), EMPTY, /*eb jmp*/IDEXW(J, jcc, 1),
...
/*2 byte_opcode_table */
  ...
  /* 0xb4 */	EMPTY, EMPTY, /*0f b6 movzbv*/IDEX(Eb2G, movzx), /*0f b7 movzwv*/IDEX(Ew2G, movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, /*be movsx*/IDEX(Eb2G, movsx), /*bf movsx*/IDEX(Ew2G, movsx),
