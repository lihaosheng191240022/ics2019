...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), /*TODO c1 shift r/l*/IDEX(I2E, gp2), EMPTY, /*0xc3 ret16/32*/EX(ret),
  ...
  /* 0xe8 */	/*0xe8 call r16/32*/IDEX(push_SI, call), /*TODO e9 jmp*/IDEX(J, jcc), EMPTY, /*TODO eb jmp*/IDEXW(J, jcc, 1),
