...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    /*0x83 /0 add*/EXW(add, 3), EMPTY, EMPTY, EMPTY,
    /*0x83 /4 and*/EX(and), /*0x83 /5 sub*/EX(sub), EMPTY, /*83 /7 cmp*/EXW(cmp, 3))
...
make_group(gp3,
    ...
    /*f7 /4 mul*/EX(mul), /*/5 imul*/EX(imul1), EMPTY, /*f7 /7 idiv*/EX(idiv))
...
make_group(gp5,
    ...
    /*ff /4 jmp*/EX(jmp), EMPTY, /*0xff /6 pushw/l*/EX(push), EMPTY)
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x20 */	EMPTY, EMPTY, /*22 and*/IDEXW(E2G, and, 1), EMPTY,
  ...
  /* 0x30 */	EMPTY, /*0x31 xor*/IDEX(G2E, xor), EMPTY, /*33 xor*/IDEX(E2G, xor),
  ...
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
	...
	/* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEXW(SI2E, gp1, 3),
  ...
  /* 0x98 */	EMPTY, /*99 cltd*/EX(cltd), EMPTY, EMPTY,
  ...
  /* 0xe8 */	/*0xe8 call r16/32*/IDEX(push_SI, call), /*e9 jmp*/IDEX(J, jmp), EMPTY, /*eb jmp*/IDEXW(J, jmp, 1),
  /* 0xec */	EMPTY, EMPTY, /*ee out*/IDEXW(out_a2dx, out, 1), /*ef out*/IDEX(out_a2dx, out),
...
/*2 byte_opcode_table */
  ...
  /* 0xbc */	EMPTY, EMPTY, /*be movsx*/IDEXW(E2G, movsx, 3), /*bf movsx*/IDEXW(E2G, movsx, 5),
