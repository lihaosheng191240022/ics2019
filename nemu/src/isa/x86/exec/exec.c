...
/* 0x0f 0x01*/
make_group(gp7,
    EMPTY, EMPTY, EMPTY, /*/3 lidt*/EX(lidt),
    EMPTY, EMPTY, EMPTY, EMPTY)
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x0c */	EMPTY, /*0d 0r*/IDEX(I2a, or), EMPTY, EX(2byte_esc),
  /* 0x10 */	/*10 adc*/IDEXW(G2E, adc, 1), EMPTY, EMPTY, /*13 adc r/mv to rv*/IDEX(E2G, adc),
  ...
  /* 0x60 */	/*60 pusha*/EX(pusha), /*61 popa*/EX(popa), EMPTY, EMPTY,
