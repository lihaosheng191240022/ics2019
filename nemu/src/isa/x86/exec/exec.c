...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    /*0x83 /0 add*/EXW(add, 3), /*80 /1 or*/EX(or), EMPTY, EMPTY,
...
make_group(gp5,
    ...
    /*ff /4 jmp*/EX(jmp), EMPTY, /*0xff /6 pushw/l*/EX(push), /*ff /7*/EX(nop))
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x68 */	/*0x68 push imm16/32*/IDEX(I, push), /*69 imul3*/IDEX(I_E2G, imul3), /*6a push imm8*/IDEXW(I, push, 1), EMPTY,
